define("ace/mode/y86_highlight_rules", ["require", "exports", "module",
    ...
    var Y86HighlightRules = function() {
      ...
      this.$rules = {
        "start": [{
          ...
          "regex": /multl|divl|modl|wrch|rdch|wrint|rdint|halt|nop|rrmovl|cmovle|cmovl|cmove|cmovne|cmovge|cmovg|irmovl|rmmovl|mrmovl|addl|subl|xorl|andl|jmp|jle|jl|je|jne|jge|jg|call|ret|pushl|popl|brk|brkle|brkl|brke|brkne|brkge|brkg/
        }, {
...
define("ace/mode/y86", ["require", "exports", "module", "ace/lib/oop",
    "ace/mode/text", "ace/mode/y86_highlight_rules"
  ],
  function(require, exports, module) {
    "use strict";
